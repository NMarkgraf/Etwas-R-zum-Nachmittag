...
Um gleichzeitig weitere, notwednige Pakete zu installieren nutzt man die Option "dependencies=TRUE":
```{r, eval=FALSE, echo=TRUE}
...
Ein großer Teil der Beispiele stammt von Prof. Dr. Oliver Gansser aus seinem Handout "Wichtige Befehle in R - Datenerhebung und Statistik" vom 15. Dezember 2016, welches mir von Prod. Dr. Schwarz freundlicherweise überlassen wurde.